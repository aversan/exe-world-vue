...
module.exports = {
  ...
  theme: {
    ...
    colorsSocial: {
      'social-vk': '#4A76A9',
      'social-facebook': '#4368B1',
      'social-ok': '#ED8323',
      'social-mailru': '#2265AB',
      'social-twitter': '#4CA0EB',
    },
    colorsElevation: {
      'elevation-00': '#27272D',
      'elevation-01': '#2D2B37',
    ...
    colorsDay: (theme) => ({
      'day-violet-primary': theme('colors.purple.650'),
      'day-violet-dark': theme('colors.purple.800'),
      'day-violet-hover': theme('colors.purple.500'),
      'day-green-primary': theme('colors.green.600'),
      'day-emerald-primary': theme('colors.teal.500'),
      'day-orange-primary': theme('colors.red.600'),
      'day-grey-primary': theme('colors.gray.650'),
      'day-grey-medium': theme('colors.gray.550'),
      'day-grey-light': theme('colors.gray.200'),
    }),
    colorsNight: (theme) => ({
      'night-violet-primary': theme('colors.purple.550'),
      'night-violet-dark': theme('colors.purple.700'),
      'night-violet-hover': theme('colors.purple.400'),
      'night-green-primary': theme('colors.green.400'),
      'night-emerald-primary': theme('colors.teal.550'),
      'night-orange-primary': theme('colors.red.400'),
    }),
    spacing: {
      px: '1px',
      0: '0',
    ...
    fontSize: {
      xxs: ['0.625rem', 1.2], // 10px
      xs: ['0.75rem', 1.333], // 12px
      sm: ['0.875rem', 1.42857], // 14px
      base: '1rem', // 16px
      lg: [
        '1.25rem',
        {
